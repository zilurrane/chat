import 'package:chat/shared/constants/color_constants.dart';
...
class ThemeConfig {
  static ThemeData get darkTheme => createTheme(
        ...
        tertiaryText: ColorConstants.tertiaryAppColor,
  ...
  static ThemeData createTheme({
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
          ...
          titleTextStyle:
              TextStyle(color: tertiaryText, fontWeight: FontWeight.bold, fontSize: 18)),
      iconTheme: IconThemeData(
        color: secondaryText,
        size: 16.0,
      ),
